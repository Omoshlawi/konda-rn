...
export const useOperators = () => {
    const url = constructUrl(`/operators`, { v: "custom:include(details)" });
...
const createOperator = async (data: OperatorFormData) => {
    const response = await apiFetch(`/operators`, { method: "POST", data });
...
const updateOperator = async (
    ...
    const response = await apiFetch(`/operators/${operatorId}`, {
        method: method,
        data,
    });
    return response.data;
...
const deleteOperator = async (
    ...
    const response = await apiFetch(`/operators/${operatorId}`, { method: method });
    return response.data;
};
